  ...
  function getDayInfo(time_ms = Date.now()) {
    ...
    return [
      ...
      },
      {
        ...
        category: "Сила накшатры",
        categoryDescription: `
          <p>Накшатры — это язык звезд, через который древние мудрецы пытались расшифровать смысл жизни. Возможно, получится и у вас.</p>
          <p>Всего накшатр 27. Рядом с названием накшатры указан её управитель, который дает понимание того, как и зачем накшатра действует, распаковывая самскары (отпечатки прошлого) в нашем сознании.</p>
