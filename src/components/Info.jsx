  ...
  function getDayInfo(time_ms = Date.now()) {
    ...
    return [
      ...
      },
      {
        ...
        category: "Тара Бала",
        categoryDescription:
          "Тара-Бала переводится как «сила накшатры». Она отражает благоприятность или неблагоприятность периода текущей накшатры на основе натального положения Луны.",
        title: taraBala.name,
        titleExtra: "",
